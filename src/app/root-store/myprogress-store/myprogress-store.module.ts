...
import {MyprogressStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([MyprogressStoreEffects]),
	],
	declarations: [],
	providers: [MyprogressStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class MyprogressStoreModule {
}
