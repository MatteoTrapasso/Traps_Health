...
@Component({
  selector: 'app-button-create-many-test-structure',
  template: `
...
export class ButtonCreateManyTestStructureComponent implements OnInit {
  ...
  onCreateMany(values: Structure[]): void {
    ...
    this.store$.dispatch(StructureStoreActions.CreateManyRequest({items}));
  }
